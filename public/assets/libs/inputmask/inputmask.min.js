                    ...
                    function resolveTestFromToken(
                        ...
                        function handleMatch(
                            ...
                            function isFirstMatch(latestMatch, tokenGroup) {
                                ...
                                if (!firstMatch) {
                                    $.each(tokenGroup.matches, function (
                                        ndx,
                                        match
                                    ) {
                ...
                function casing(elem, test, pos) {
                    switch (opts.casing || test.casing) {
                        ...
                        case "lower":
                            ...
                            break;
                        case "title":
                            var posBefore = getMaskSet().validPositions[
                                pos - 1
                            ];
                            if (
                                pos === 0 ||
                    ...
                    if (lAltPos === -1 && rAltPos === undefined) {
                        ...
                        for (; lAltPos >= 0; lAltPos--) {
                            ...
                            if (altPos && altPos.alternation !== undefined) {
                                ...
                                lastAlt = lAltPos;
                                alternation = getMaskSet().validPositions[
                                    lastAlt
                                ].alternation;
                                prevAltPos = altPos;
                            }
                    ...
                    if (result === true) {
                        ...
                        if (maxLength === undefined || maskPos < maxLength) {
                            ...
                            if (
                                ...
                                var currentPosValid = getMaskSet()
                                    .validPositions[maskPos];
                                if (
                                    currentPosValid &&
                    ...
                    for (var ps = originalPos; ps < newPos; ps++) {
                        if (
                            ...
                            if (vp) {
                                ...
                                if (fillOnly !== true) {
                                    var cvpInput = getMaskSet().validPositions[
                                        newPos
                                    ].input;
                                    getMaskSet().validPositions[
                                        newPos
                                ...
                                if (isValid === true) {
                                    if (
                                        ...
                                        while (
                                            ...
                                            bufferTemplate = bufferTemplate.slice(
                                                1
                                            );
                                        }
                                        processValue = processValue.replace(
